...
public class AdminTopicController {
    ...
    public Object list(String title, String subtitle,
        ...
        List<SugoTopic> topicList = topicService.querySelective(title, subtitle, page, limit, sort, order);
        return ResponseUtil.okList(topicList);
    }

    private Object validate(SugoTopic topic) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody SugoTopic topic) {
    ...
    @PostMapping("/update")
    public Object update(@RequestBody SugoTopic topic) {
        Object error = validate(topic);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody SugoTopic topic) {
