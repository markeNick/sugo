...
import com.sugo.admin.vo.CategoryVo;
...
public class AdminCategoryController {
    ...
    public Object list() {
        ...
        List<SugoCategory> categoryList = categoryService.queryByPid(0);
        for (SugoCategory category : categoryList) {
            ...
            List<SugoCategory> subCategoryList = categoryService.queryByPid(category.getId());
            for (SugoCategory subCategory : subCategoryList) {
    ...
    private Object validate(SugoCategory category) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody SugoCategory category) {
    ...
    public Object read(@NotNull Integer id) {
        SugoCategory category = categoryService.findById(id);
        return ResponseUtil.ok(category);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody SugoCategory category) {
        Object error = validate(category);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody SugoCategory category) {
    ...
    public Object catL1() {
        ...
        for (SugoCategory category : l1CatList) {
