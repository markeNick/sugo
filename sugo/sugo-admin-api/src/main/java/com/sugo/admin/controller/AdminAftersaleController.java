...
import com.sugo.sql.service.AftersaleService;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.apache.shiro.authz.annotation.RequiresPermissions;
import com.sugo.admin.annotation.RequiresPermissionsDesc;
import com.sugo.admin.service.LogHelper;
import com.sugo.admin.util.AdminResponseCode;
...
import static com.sugo.admin.util.AdminResponseCode.ORDER_REFUND_FAILED;
...
public class AdminAftersaleController {
    ...
    public Object list(Integer orderId, String aftersaleSn, Short status,
        ...
        List<SugoAftersale> aftersaleList = aftersaleService.querySelective(orderId, aftersaleSn, status, page, limit, sort, order);
    ...
    @PostMapping("/recept")
    public Object recept(@RequestBody SugoAftersale aftersale) {
        Integer id = aftersale.getId();
        SugoAftersale aftersaleOne = aftersaleService.findById(id);
    ...
    public Object batchRecept(@RequestBody String body) {
        ...
        for(Integer id : ids) {
            SugoAftersale aftersale = aftersaleService.findById(id);
            if(aftersale == null){
                continue;
            }
    ...
    @PostMapping("/reject")
    public Object reject(@RequestBody SugoAftersale aftersale) {
        Integer id = aftersale.getId();
        SugoAftersale aftersaleOne = aftersaleService.findById(id);
        if(aftersaleOne == null){
    ...
    @PostMapping("/refund")
    public Object refund(@RequestBody SugoAftersale aftersale) {
        Integer id = aftersale.getId();
        SugoAftersale aftersaleOne = aftersaleService.findById(id);
        if(aftersaleOne == null){
            return ResponseUtil.badArgumentValue();
        ...
        SugoOrder order = orderService.findById(orderId);
