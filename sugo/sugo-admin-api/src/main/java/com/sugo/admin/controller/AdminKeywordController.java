...
public class AdminKeywordController {
    ...
    public Object list(String keyword, String url,
        ...
        List<SugoKeyword> keywordList = keywordService.querySelective(keyword, url, page, limit, sort, order);
        return ResponseUtil.okList(keywordList);
    }

    private Object validate(SugoKeyword keywords) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody SugoKeyword keyword) {
    ...
    public Object read(@NotNull Integer id) {
        SugoKeyword keyword = keywordService.findById(id);
        return ResponseUtil.ok(keyword);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody SugoKeyword keyword) {
        Object error = validate(keyword);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody SugoKeyword keyword) {
