...
public class OrderJob {
    ...
    public void checkOrderUnconfirm() {
        ...
        List<SugoOrder> orderList = orderService.queryUnconfirm(SystemConfig.getOrderUnconfirm());
    ...
    public void checkOrderComment() {
        ...
        List<SugoOrder> orderList = orderService.queryComment(SystemConfig.getOrderComment());
        for (SugoOrder order : orderList) {
