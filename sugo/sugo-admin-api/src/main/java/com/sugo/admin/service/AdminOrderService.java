...
public class AdminOrderService {
    ...
    public Object list(Integer userId, String orderSn, LocalDateTime start, LocalDateTime end, List<Short> orderStatusArray,
        ...
        List<SugoOrder> orderList = orderService.querySelective(userId, orderSn, start, end, orderStatusArray, page, limit,
                sort, order);
        return ResponseUtil.okList(orderList);
    }

    public Object detail(Integer id) {
        SugoOrder order = orderService.findById(id);
        List<SugoOrderGoods> orderGoods = orderGoodsService.queryByOid(id);
    ...
    public Object reply(String body) {
        ...
        // 目前只支持回复一次
        SugoComment comment = commentService.findById(commentId);
        if(comment == null){
            return ResponseUtil.badArgument();
        }
