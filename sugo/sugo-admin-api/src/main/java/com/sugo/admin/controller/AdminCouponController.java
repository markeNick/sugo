...
public class AdminCouponController {
    ...
    public Object list(String name, Short type, Short status,
        ...
        List<SugoCoupon> couponList = couponService.querySelective(name, type, status, page, limit, sort, order);
    ...
    public Object listuser(Integer userId, Integer couponId, Short status,
                           ...
                           @Sort @RequestParam(defaultValue = "add_time") String sort,
                           @Order @RequestParam(defaultValue = "desc") String order) {
        List<SugoCouponUser> couponList = couponUserService.queryList(userId, couponId, status, page,
                limit, sort, order);
        return ResponseUtil.okList(couponList);
    }

    private Object validate(SugoCoupon coupon) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody SugoCoupon coupon) {
    ...
    public Object read(@NotNull Integer id) {
        SugoCoupon coupon = couponService.findById(id);
        return ResponseUtil.ok(coupon);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody SugoCoupon coupon) {
        Object error = validate(coupon);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody SugoCoupon coupon) {
