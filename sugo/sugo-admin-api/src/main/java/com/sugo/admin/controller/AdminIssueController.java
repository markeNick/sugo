...
import com.sugo.sql.service.IssueService;
...
public class AdminIssueController {
    ...
    public Object list(String question,
        ...
        List<SugoIssue> issueList = issueService.querySelective(question, page, limit, sort, order);
        return ResponseUtil.okList(issueList);
    }

    private Object validate(SugoIssue issue) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody SugoIssue issue) {
    ...
    public Object read(@NotNull Integer id) {
        SugoIssue issue = issueService.findById(id);
        return ResponseUtil.ok(issue);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody SugoIssue issue) {
        Object error = validate(issue);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody SugoIssue issue) {
