...
import static com.sugo.admin.util.AdminResponseCode.ADMIN_INVALID_ACCOUNT;
...
public class AdminProfileController {
    ...
    public Object lsNotice(String title, String type,
        ...
        List<SugoNoticeAdmin> noticeList = noticeAdminService.querySelective(title, type, getAdminId(), page, limit, sort, order);
    ...
    public Object catNotice(@RequestBody String body) {
        ...
        SugoNoticeAdmin noticeAdmin = noticeAdminService.find(noticeId, getAdminId());
        if(noticeAdmin == null){
        ...
        SugoNotice notice = noticeService.findById(noticeId);
        ...
        if(adminId.equals(0)){
            ...
            SugoAdmin admin = adminService.findById(notice.getAdminId());
